        ...
        <div className="p-4">
          ...
          <div className="relative w-full mt-3">
            ...
            <input
              ...
              className="placeholder:text-[12px] text-[12px] w-full pl-7 pr-3 py-2 bg-brand-grey-150 border border-brand-grey-100 rounded-lg text-black placeholder:text-brand-grey-200 focus:outline-none focus:ring-1 focus:ring-brand-light-blue-300"
            />
          </div>
        </div>
